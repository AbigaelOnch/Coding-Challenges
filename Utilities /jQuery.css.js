...
The return value of most jQuery manipulation APIs return the jQuery object itself, so that method calls can be chained. 
The above can be further simplified again:
    ...
    return {
        css: function (property, value){
            ...
            if(value === undefined){
                ...
                const currStyle = element.style[property]
                return currStyle === '' ? undefined : currStyle;
            }
